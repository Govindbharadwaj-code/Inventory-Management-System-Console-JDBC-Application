...
2. Run the SQL file:
   ...
   ```
3. This creates database `inventorydb` with 3 tables + sample data

---

## How to Run (Eclipse or IntelliJ)
1. Import as a Java Project
2. Add `mysql-connector-j-8.x.x.jar` to the build path
3. In `DBUtil.java`, update credentials if needed:
   ```java
